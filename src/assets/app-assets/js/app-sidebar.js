...
$(document).ready(function () {
  ...
  $('.trip-tracking .trip-icon i').click(function () {
    var iconHover = $(this).siblings('.icon-hover');
    if (iconHover.hasClass("active")) {
      iconHover.removeClass("active");
    } else {
      $('.trip-tracking .icon-hover').removeClass('active')
      iconHover.addClass("active");
    }
  });
  ...
  subMenu.click(function () {
    ...
    console.log('chxujd')
        ...
        if (!subMenu.children('li').hasClass('is-shown')) {
          subMenu.children('li').addClass('is-shown');
        }
      } 
  })
  ...
  $sidebar_content.on('click', '.navigation li', function () {
    var $this = $(this),
      listItem = $this;

    if (listItem.hasClass('has-sub') && listItem.hasClass('open')) {
      collapse(listItem);
      listItem.children('a').children('i').addClass("fa-chevron-down");
      listItem.children('a').children('i').removeClass("fa-chevron-up");
    } else {
      if (listItem.hasClass('has-sub')) {
        expand(listItem);
        listItem.children('a').children('i').addClass("fa-chevron-up");
        listItem.children('a').children('i').removeClass("fa-chevron-down");
      }
      ...
      // If menu accordion then close all except clicked once
        ...
        openListItems.children('a').children('i').addClass("fa-chevron-down");
        openListItems.children('a').children('i').removeClass("fa-chevron-up");
  ...
  $('.nav-toggle').on('click', function () {
    ...
    console.log('chxujd')
      ...
      $('.has-sub').children('ul').children('li').removeClass('is-shown')
      $('.has-sub').removeClass('open')
      $('.has-sub').children('a').children('i').removeClass("fa-chevron-up");
      $('.has-sub').children('a').children('i').addClass("fa-chevron-down");
